...
public class BossModel extends GeoModel<BossEntity> {
    ...
    public ResourceLocation getModelResource(BossEntity animatable) {
        ...
        return ResourceLocation.fromNamespaceAndPath(DevilMod.MOD_ID, "geo/boss.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BossEntity animatable) {
        // Путь к текстуре .png
        return ResourceLocation.fromNamespaceAndPath(DevilMod.MOD_ID, "textures/entity/boss.png");
    }

    @Override
    public ResourceLocation getAnimationResource(BossEntity animatable) {
        // Путь к файлу анимаций .animation.json
        return ResourceLocation.fromNamespaceAndPath(DevilMod.MOD_ID, "animations/boss.animation.json");
    }
}
